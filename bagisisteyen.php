...
<div class="container">    <!--   container alanı -->
    <div class="kaplayan_alan" > <!--   containerin kapladığı alan -->
        <div class="bagislayan_bilgi"> <!--   bağışlayan textlerin yer aldığı alan -->
            ...
            <div class="textler"  >
                    <input id="box1"  type="text" name="ad" placeholder="Lütfen Adınızı Giriniz"  /> 
                         ...
                         <input id="box2" type="text" name="soyad" placeholder="Lütfen Soyadınızı Giriniz" />
                          ...
                          <?php
                                $sehir_stmt = $pdo->query("SELECT * FROM il");    //illeri listeleyen selectbox için php kodları
                        ...
                        ?>
                          ...
                          <option value="">Bir İlçe Seçiniz</option>
                             ...
                             <?php
                                $kan_stmt = $pdo->query("SELECT * FROM kan_gruplari");      // databaseden girilen kan gruplarını select içine getiren php kodları
